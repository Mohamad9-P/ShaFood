...
export default function Form() {
  ...
  async function handelaction(state, formdata) {
    ...
    const NewData = cartData.map((prev) => {
      return {
        name: prev.name,
        id: prev.id,
        price: prev.price,
  ...
  const [action, actionstate, pending] = useActionState(handelaction, {
    error: null,
  });
          ...
          <form action={actionstate}>
            ...
            <div className="divform">
              ...
              <input
                ...
                type="text"
                defaultValue={
                  action.defaultvalue ? action.defaultvalue.fullname : null
                }
              />
            </div>
            <div className="divform">
              ...
              <input
                ...
                type="text"
                defaultValue={
                  action.defaultvalue ? action.defaultvalue.Email : null
                }
              />
            </div>
            <div className="divform">
              ...
              <input
                ...
                name="street"
                defaultValue={
                  action.defaultvalue ? action.defaultvalue.street : null
                }
              />
            </div>
            <div className="divform">
              ...
              <input
                ...
                name="postal"
                defaultValue={
                  action.defaultvalue ? action.defaultvalue.postal : null
                }
              />
            </div>
            <ul className="error">
            ...
            <div className="buttons">
              ...
              <Buttons className="text-button" type="submit" disabled={pending}>
                Submit Order
              </Buttons>
            </div>
          </form>
